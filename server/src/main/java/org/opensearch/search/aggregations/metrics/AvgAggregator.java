...
class AvgAggregator extends NumericMetricsAggregator.SingleValue implements StarTreePreComputeCollector {
    ...
    public LeafBucketCollector getLeafCollector(LeafReaderContext ctx, final LeafBucketCollector sub) throws IOException {
        ...
        org.apache.logging.log4j.LogManager.getLogger(AvgAggregator.class)
            .info("[DSL-TRACE] avg agg '{}' getLeafCollector -> opening numeric doubleValues (Parquet-backed DV)", name());
